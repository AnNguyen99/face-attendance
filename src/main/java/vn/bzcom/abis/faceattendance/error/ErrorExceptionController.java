package vn.bzcom.abis.faceattendance.error;
...
import vn.bzcom.abis.faceattendance.account.exception.AccountNotFoundException;
import vn.bzcom.abis.faceattendance.account.exception.EmailDuplicationException;
...
public class ErrorExceptionController {
    ...
    // TODO: Have to remove comment when added password change controller
//    @ExceptionHandler(PasswordFailedExceededException.class)
//    @ResponseStatus(HttpStatus.BAD_REQUEST)
//    protected ErrorResponse handlePasswordFieldFailedExceededException(PasswordFailedExceededException e) {
//        log.error(e.getMessage());
